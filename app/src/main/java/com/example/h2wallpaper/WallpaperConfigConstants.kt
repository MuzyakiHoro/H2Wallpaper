...
object WallpaperConfigConstants {
    ...
    const val DEFAULT_BLUR_DOWNSCALE_FACTOR_INT: Int = 25
    ...
    // Scaled Integer Defaults for SeekBarPreferences
    ...
    val DEFAULT_BACKGROUND_INITIAL_OFFSET_INT: Int =
        (DEFAULT_BACKGROUND_INITIAL_OFFSET * 10).toInt()
    val DEFAULT_P2_BACKGROUND_FADE_IN_RATIO_INT: Int =
        (DEFAULT_P2_BACKGROUND_FADE_IN_RATIO * 100).toInt()
    ...
    val DEFAULT_P1_IMAGE_BOTTOM_FADE_HEIGHT_INT: Int =
        DEFAULT_P1_IMAGE_BOTTOM_FADE_HEIGHT.roundToInt()

    // Constants for FocusActivity Intents (previously in FocusParams object)
    object FocusParams {
        ...
        // const val REQUEST_CODE_FOCUS_SELECTION = 1001 // 这个请求码如果只在 MainActivity 用，可以保留在 MainActivity 的 companion object
    }
}